...
use App\Repository\ExamenCabezaRepository;
use Symfony\Component\Validator\Constraints as Assert;
use DateTimeInterface;

#[ORM\Entity(repositoryClass: ExamenCabezaRepository::class)]
class ExamenCabeza
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: HistorialClinico::class, inversedBy: 'examenesCabeza')]
    #[ORM\JoinColumn(nullable: false)]
