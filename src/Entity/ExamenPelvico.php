...
use App\Repository\ExamenPelvicoRepository;
use Symfony\Component\Validator\Constraints as Assert;
use DateTimeInterface;

#[ORM\Entity(repositoryClass: ExamenPelvicoRepository::class)]
class ExamenPelvico
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: HistorialClinico::class, inversedBy: 'examenesPelvico')]
    #[ORM\JoinColumn(nullable: false)]
