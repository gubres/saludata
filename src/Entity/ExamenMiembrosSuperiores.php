...
use App\Repository\ExamenMiembrosSuperioresRepository;
use Symfony\Component\Validator\Constraints as Assert;
use DateTimeInterface;

#[ORM\Entity(repositoryClass: ExamenMiembrosSuperioresRepository::class)]
class ExamenMiembrosSuperiores
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: HistorialClinico::class, inversedBy: 'examenesMiembrosSuperiores')]
    #[ORM\JoinColumn(nullable: false)]
