...
use App\Repository\ExamenMiembrosInferioresRepository;
use Symfony\Component\Validator\Constraints as Assert;
use DateTimeInterface;

#[ORM\Entity(repositoryClass: ExamenMiembrosInferioresRepository::class)]
class ExamenMiembrosInferiores
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: HistorialClinico::class, inversedBy: 'examenesMiembrosInferiores')]
    #[ORM\JoinColumn(nullable: false)]
